...
public class WriteXMLFile {
	...
	public void agregar(String[] pLista, Element pElement)
	{
		pElement.addContent(new Element("first").setText(pLista[0]));
		pElement.addContent(new Element("first").setText(pLista[1]));
		pElement.addContent(new Element("first").setText(pLista[2]));
    ...
    public static void main(String[] args) {
      ...
      try {
        ...
        staff3.addContent(new Element("etiquetadios").setText("fong fong"));
